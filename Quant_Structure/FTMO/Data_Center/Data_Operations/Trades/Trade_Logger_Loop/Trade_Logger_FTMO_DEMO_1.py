# -*- coding: utf-8 -*-
"""
Quant_Structure/FTMO/Data_Center/Data_Operations/Trades/Trade_Logger_Loop/Trade_Logger_FTMO_DEMO_1.py
...
- Speicherung erfolgt in SQLite.
- Zusätzlich werden account_type und server gespeichert.
- Es wird UPSERT verwendet statt INSERT OR IGNORE.
"""
...
FIXED_TERMINAL_EXE = Path(
    r"C:\Users\Leon\Desktop\Terminals\MetaTrader 5 - Kopie - Kopie - Kopie (16) - Kopie - Kopie - Kopie - Kopie\terminal64.exe"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "1512846122"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "$4BnW7iq@4nj")
