# -*- coding: utf-8 -*-
"""
Quant_Structure/FTMO/Data_Center/Data_Operations/Trades/Trade_Logger_Loop/Trade_Logger_FTMO_DEMO_2.py
...
MT5_LOGIN = int(os.getenv("MT5_LOGIN", "1512846129"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "f5Mr*WW*klBS")
